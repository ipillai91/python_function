...
```json
{
  "functionName" : "hello",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/ipillai91/python_function.git",
  "includeTap" : true,
  "interfaceType" : "http",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/python-functions-accelerator.git->https://github.com/i...(truncated), my-python-fn->python-function, main->main]
